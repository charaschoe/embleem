...
export const doppelkoepfigerAdler: Animal = {
	...
	synonyms: ['double-headed eagle', 'Albanian eagle', 'black eagle', 'Shqiponja e zezë'],
	searchStrategy: {
...
export const weisserAdler: Animal = {
	...
	synonyms: ['white eagle', 'Polish eagle', 'Piast eagle', 'Orzeł Biały'],
	searchStrategy: {
...
export const leoBelgicus: Animal = {
	...
	synonyms: ['Belgian Lion', 'Leo Belgicus', 'lion', 'Belgische Leeuw'],
	searchStrategy: {
...
export const bengalischerTiger: Animal = {
	...
	synonyms: ['Bengal tiger', 'Indian tiger', 'royal Bengal tiger', 'Königstiger'],
	searchStrategy: {
...
export const malaiischerTiger: Animal = {
	...
	synonyms: ['Malayan tiger', 'Malaysian tiger', 'tiger', 'Harimau Malaya'],
	searchStrategy: {
...
export const druk: Animal = {
	...
	synonyms: ['thunder dragon', 'Bhutanese dragon', 'dragon', 'Thunder Dragon Kingdom'],
	searchStrategy: {
...
export const gallischerHahn: Animal = {
	...
	synonyms: ['Gallic rooster', 'French rooster', 'coq gaulois', 'le coq'],
	searchStrategy: {
...
export const quetzal: Animal = {
	...
	synonyms: ['resplendent quetzal', 'Guatemalan quetzal', 'quetzal', 'Quetzal resplandeciente'],
	searchStrategy: {
...
export const komododrache: Animal = {
	...
	synonyms: ['Komodo dragon', 'Indonesian dragon', 'monitor lizard', 'Komodowaran'],
	searchStrategy: {
...
export const markhor: Animal = {
	...
	synonyms: ['screw-horned goat', 'Pakistani markhor', 'wild goat', 'Schraubenziege'],
	searchStrategy: {
...
export const springbock: Animal = {
	...
	synonyms: ['springbok', 'South African springbok', 'antelope', 'pronking antelope'],
	searchStrategy: {
...
export const steppenzebra: Animal = {
	...
	synonyms: ['plains zebra', 'Botswana zebra', 'zebra', 'common zebra'],
	searchStrategy: {
...
export const heiligekuh: Animal = {
	...
	synonyms: ['cow', 'sacred cow', 'Nepalese cow', 'holy cow'],
	searchStrategy: {
...
export const koeniglicherLoewe: Animal = {
	...
	synonyms: ['Royal Lion', 'English Lion', 'lion rampant', 'heraldic lion'],
	searchStrategy: {
...
export const russischerBaer: Animal = {
	...
	synonyms: ['Russian Bear', 'brown bear', 'Eurasian bear', 'Медведь'],
	searchStrategy: {
...
export const kaenguru: Animal = {
	...
	synonyms: ['kangaroo', 'red kangaroo', 'Australian kangaroo', 'Rotes Riesenkänguru'],
	searchStrategy: {
...
export const andenkondor: Animal = {
	...
	synonyms: ['Andean Condor', 'vultur gryphus', 'Chilean condor', 'Großer Kondor'],
	searchStrategy: {
...
export const chinesischerDrache: Animal = {
	...
	synonyms: ['Chinese Dragon', 'imperial dragon', 'Lóng', '龙'],
	searchStrategy: {
...
export const weiskopfseeadler: Animal = {
	...
	synonyms: ['Bald Eagle', 'American Eagle', 'national bird', 'American symbol'],
	searchStrategy: {
...
export const kiwi: Animal = {
	...
	synonyms: ['New Zealand Kiwi', 'flightless bird', 'brown kiwi', 'Streifenkiwi'],
	searchStrategy: {
...
export const kanadischerBiber: Animal = {
	...
	synonyms: ['Canadian Beaver', 'North American beaver', 'national symbol', 'Amerikanischer Biber'],
	searchStrategy: {
...
export const irischerHirsch: Animal = {
	...
	synonyms: ['Irish Deer', 'Celtic Deer', 'heraldic stag', 'Keltischer Hirsch'],
	searchStrategy: {
...
export const phoenixVogel: Animal = {
	...
	synonyms: ['Phoenix', 'Firebird', 'Greek phoenix', 'Feuervogel'],
	searchStrategy: {
...
export const schottischerEinhorn: Animal = {
	...
	synonyms: ['Scottish Unicorn', 'royal unicorn', 'heraldic unicorn', 'Königliches Einhorn'],
	searchStrategy: {
...
export const walisischerDrache: Animal = {
	...
	synonyms: ['Welsh Dragon', 'Red Dragon', 'Y Ddraig Goch', 'Roter Drache'],
	searchStrategy: {
...
export const norwegischerLoewe: Animal = {
	...
	synonyms: ['Norwegian Lion', 'Nordic Lion', 'heraldic lion', 'Nordischer Löwe'],
	searchStrategy: {
...
export const spanischerStier: Animal = {
	...
	synonyms: ['Spanish Bull', 'Osborne Bull', 'Toro de Osborne', 'Osborne-Stier'],
	searchStrategy: {
...
export const singapurMerlion: Animal = {
	...
	synonyms: ['Merlion', 'Singapore Merlion', 'lion-fish', 'Löwenfisch'],
	searchStrategy: {
...
export const sriLankaLoewe: Animal = {
	...
	synonyms: ['Sri Lankan Lion', 'Sinhala Lion', 'Ceylon Lion', 'සිංහ කොටිය'],
	searchStrategy: {

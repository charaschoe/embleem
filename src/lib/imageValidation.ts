...
const NEGATIVE_KEYWORDS = [
  ...
  'statue', 'sculpture', 'mural', 'graffiti', 'tattoo',
  'costume', 'mask', 'puppet', 'doll', 'figurine',
  'photo', 'wildlife', 'nature', 'zoo', 'farm',
  'real', 'living', 'wild', 'pet'
];
...
export function getAnimalHint(animal: Animal): string {
  ...
  return hints[animal.name] || `Dieses Wappentier ist ein wichtiges heraldisches Symbol von ${animal.country}.`;
} 